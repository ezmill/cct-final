...
function renderMobile(){
	...
	smileyImage.src = "img/smiley.svg";
	smileyImage.style.display = "block";
	smileyImage.style.position = "absolute";
	smileyImage.style.top = "50%";
	smileyImage.style.left = "50%";
	smileyImage.style.width = "20%";
	smileyImage.style.height = "20%";
	smileyImage.style.transform = "translate(-50%, -50%)";
	smileyImage.style.webkitTransform = "translate(-50%, -50%)";
	smileyImage.style.mozTransform = "translate(-50%, -50%)";

	// smileyImage = features.first().find(".feature-image");
	// var smiley
	// $(smileyImage).css("display", "block");
	$(smiley).append(smileyImage);
	wrapper.prepend(smiley);
}
